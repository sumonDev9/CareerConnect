        ...
        <div className='flex items-start'>
         {/* login */}
            <div className='p-5  md:p-0'>
                <div className='shadow-lg'>
                    ...
                    <button className='btn btn-block flex items-center bg-gray-200 text-lg text-info'><img className='w-6 h-6' src="https://i.ibb.co/TcB5YZK/icons8-google-48.png" alt="" /> Continue with Google</button>
                        ...
                        <div>
                            <p className='text-center text-base mt-3 md:text-lg ml-8'><span className='text-black opacity-60'>Don't have an account?</span> <Link to='/register' className='text-blue-500 hover:underline'>Register here</Link></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='md:w-[480px] md:block  shadow-2xl bg-white  hidden items-center justify-center p-6'>
                   ...
                   <p className='text-info text-lg'>Join us to connect with top companies, find your dream job, and take your career to the next level. Discover new opportunities effortlessly on CareerConnect!</p>
